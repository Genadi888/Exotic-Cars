...
const registerTemplate = (getUsernameInputHandler, getPasswordInputHandler, getEmailInputHandler) => html`
...
export function registerView(ctx) {
	ctx.render(registerTemplate(getUsernameInputHandler, getPasswordInputHandler, getEmailInputHandler));
